...
module.exports.AddOrderquery = async (u_id, amount, date, payment_method, user_name, user_email, user_mobile_no, user_address, user_state, user_district, user_city, user_zipcode) => {
    var Query = `insert into orders (u_id,od_amount, od_created_at, od_payment_method, user_name, user_email, user_mobile_no, user_address,user_state, user_district, user_city, user_zipcode) values(?,?,?,?,?,?,?,?,?,?,?,?)`;
